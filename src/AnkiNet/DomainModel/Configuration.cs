...
public readonly record struct Configuration
{
    ...
    /// </summary>
    public bool SortBackwards { get; init; }

    /// <summary>
    /// The id of the last deck selected (during review, adding card, changing the deck of a card)
    /// </summary>
    public DeckId CurrentDeck { get; init; }

    /// <summary>
    /// 'Preferences > Basic > Show remaining card count during review'.
    /// </summary>
    public bool DueCounts { get; init; }
    ...
    /// </summary>
    public string SortType { get; init; } = string.Empty;

    /// <summary>
    /// Id of the last note type (a.k.a. model) used
    /// (i.e. either when creating a note, or changing the note type of a note).
    /// </summary>
    public NoteTypeId CurrentNoteType { get; init; }
    ...
    /// </summary>
    public NewCardOrder NewSpread { get; init; }
    ...
    /// </summary>
    public bool DayLearnFirst { get; init; }

    /// <summary>
    /// TODO
    /// </summary>
    public int SchedulerVersion { get; init; }

    /// <summary>
    /// TODO
    /// </summary>
    public int CreationOffset { get; init; }

    /// <summary>
    /// The list containing the current deck id and its descendent (as ints)
    /// </summary>
    public ImmutableArray<DeckId> ActiveDecks { get; init; } = [];
    ...
    /// </summary>
    public long LastUnburied { get; init; }
    ...
    /// </summary>
    public ImmutableArray<string> ActiveColumns { get; init; } = [];
}
